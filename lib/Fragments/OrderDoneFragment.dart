...
class OrderDoneFragment extends StatefulWidget {
  const OrderDoneFragment({super.key});

  @override
  State<OrderDoneFragment> createState() => _OrderDoneFragmentState();
}

class _OrderDoneFragmentState extends State<OrderDoneFragment> {
  ...
  void initState() {
    ...
    super.initState();
    o.initCompletedHistory();
    sc.addListener(() {
      if (sc.position.pixels == sc.position.maxScrollExtent && searchTF.text.isNotEmpty) {
        o.getMoreCompletedHistory();
      }
    });
  }
          ...
          children: [
            Padding(
              ...
              child: TextFormField(
                controller: searchTF,
                onChanged: (value) {
                  o.searchCompletedHistory(searchTF.text);
                },
            ...
            Obx(() => Expanded(
                  ...
                  controller: sc,
                  itemCount: o.completeHistoryList.length,
                  itemBuilder: (context, index) {
                    var order = o.completeHistoryList[index];
                    return Padding(
